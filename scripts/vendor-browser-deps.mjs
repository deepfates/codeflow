...
const packages = [
  { name: 'd3-sankey-circular', version: '0.34.0', license: 'MIT', licenseUrl: 'https://unpkg.com/d3-sankey-circular@0.34.0/LICENSE' },
  { name: 'd3-array', version: '1.2.4', license: 'BSD-3-Clause', licenseUrl: 'https://unpkg.com/d3-array@1.2.4/LICENSE' },
  { name: 'd3-collection', version: '1.0.7', license: 'BSD-3-Clause', licenseUrl: 'https://unpkg.com/d3-collection@1.0.7/LICENSE' },
  { name: 'd3-shape', version: '1.3.7', license: 'BSD-3-Clause', licenseUrl: 'https://unpkg.com/d3-shape@1.3.7/LICENSE' },
  { name: 'd3-path', version: '1.0.9', license: 'BSD-3-Clause', licenseUrl: 'https://unpkg.com/d3-path@1.0.9/LICENSE' },
  { name: 'elementary-circuits-directed-graph', version: '1.3.1', license: 'MIT', licenseUrl: 'https://unpkg.com/elementary-circuits-directed-graph@1.3.1/LICENSE' },
  { name: 'strongly-connected-components', version: '1.0.1', license: 'MIT', licenseUrl: 'https://unpkg.com/strongly-connected-components@1.0.1/LICENSE' },
